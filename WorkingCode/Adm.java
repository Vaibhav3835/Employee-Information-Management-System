	...
	public static void createAdminFrame() {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				background.setBounds(-10, 0, 1385, 735);
...
//	        	     // left side panel image of employee_logo.
				...
				Image temp_img = img.getScaledInstance(120, 90, Image.SCALE_SMOOTH);
				bg_image = new ImageIcon(temp_img);
				JLabel logo = new JLabel("", bg_image, JLabel.CENTER);
				logo.setLayout(null);
				logo.setBounds(40, 10, 120, 90);
				leftPanel.add(logo);
				// ********************************************************ALL PANLES  DETAILS**************************
				// a panel for search eid(all panel for employee info button)
				 ...
				 JPanel homepanel = new JPanel();
				  ...
				  homepanel.setBounds(200,50,1260,635);
				...
				epropanel.setBounds(305, 70, 970, 600);
				...
				infopropanel.setBounds(305, 70, 970, 600);
				...
				addpanel.setBounds(305, 70, 970, 600);
				...
				dpanel.setBounds(305, 70, 970, 600);
				...
				reviewpanel.setBounds(305, 70, 970, 600);
				...
				reviewinpanel.setBounds(305, 70, 970, 600);
				...
				feedpanel1.setBounds(305, 70, 970, 600);
				...
				feedpanel.setBounds(305, 70, 970, 600);
				...
				projectpanel.setBounds(305, 70, 970, 600);
				...
				payrollpanel.setBounds(305, 70, 970, 600);
				...
				payrollpanel.setVisible(false);
				 ...
				 JPanel leavepanel = new JPanel();
				  ...
				  leavepanel.setBounds(200,50,1260,635);
...
//				efd2.setOpaque(true)
				...
				efd12.setBounds(570, 280, 280, 35);
...
//				 Seid.setBackground(255, 102, 102);
				...
				u1panel.add(ufd12);
				ufd12.setBounds(570, 280, 280, 35);
